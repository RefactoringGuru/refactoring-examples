...
# Обратите внимание, что если переменная не была проинициализирована при объявлении, то при её превращении в константу, надо эту инициализацию произвести (иначе будет ошибка объявления константы). Для этого присвойте ей любое временное значение.

Go to "double discountFactor|||"

Print " = 0"

#C Давайте запустим компиляцию и посмотрим, присваиваются ли нашим переменным ещё значения.
