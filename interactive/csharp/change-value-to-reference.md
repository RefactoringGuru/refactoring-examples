...
# В сложившейся ситуации не имеется возможности динамически устанавливать покупателя для заказа по его имени. Исправим это, добавив в класс <code>Order</code> новый метод.
