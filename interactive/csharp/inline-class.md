...
1. Создайте в классе-приёмнике публичные свойства и методы, которые есть в классе-доноре. Методы должны обращаться к аналогичным методам класса-донора.

2. Замените все обращения к классу-донору обращениями к свойствам и методам класса-приёмника.
...
# Начнём с объявления в классе <code>Person</code> всех видимых свойств класса телефонного номера.
...
# После того, как вся функциональная часть перемещена, можно удалить неиспользуемые свойства и методы старого класса.
