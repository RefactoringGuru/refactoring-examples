...
# Допустим, требуется вычислить плату за входной билет на стадион, для которой есть отдельный зимний и летний тариф.

Select name of "getTicketPrice"

# Наша задача — сделать этот условный оператор проще для понимания. Начнем с выделения условия в новый метод с более очевидным названием.
