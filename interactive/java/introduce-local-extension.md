...
4. Создайте в классе новые расширенные методы. Переместите в класс внешние методы из других классов, либо удалите их, если расширение уже имеет такой функционал.
...
# <i>Введение локального расширения</i> можно осуществить двумя способами — через создания класса-наследника, либо класса-обёртки. В этом примере мы пойдём путём наследования.

# Сначала создадим новый класс дат, как подкласс оргинального класса <code>Date</code>
