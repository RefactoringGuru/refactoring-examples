...
# Единственное различие между подклассами здесь в том, что в них есть реализации абстрактного метода, возвращающие жестко закодированные константы. От таких классов лучше избавиться.
...
# Теперь в родительском классе объявим поля для каждого метода, возращавшего константы в подклассах.
...
# Добавляем в родительский класс защищенный конструктор.
