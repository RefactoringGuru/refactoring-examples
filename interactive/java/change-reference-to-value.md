...
#|en| One more problem. Values with identical data should be equal when compared. To do this in Java, define special <code>equals</code> and <code>hash</code> methods in the classes being compared.
