...
# Есть ещё одна проблема. Объекты-значения с одинаковымми данными должны быть равны при сравнивании. Чтобы сделать это на языке Java, нужно определить в сравниваемых классах специальные методы <code>equals</code> и <code>hash</code>.
