...
# На этом этапе всё готово, чтобы начать перемещать методы и поля, нужные только для определенных типов служащих, в соответствующие классы.

Select "payAmount()"

# В нашем случае, создадим методы <code>payAmount</code> в каждом из подклассов и переместим туда расчеты зарплаты для соответствующих типов служащих.
