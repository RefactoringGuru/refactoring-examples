...
// Где-то в недрах клиентского кода
...
# В этот класс мы помещаем поле группы крови из класса <code>Person</code>, конструктор, инициализирующий знаение поля, а также его геттер.
