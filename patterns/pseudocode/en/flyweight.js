// Объект легковес. Каждый такой объект будет занимать много памяти, но их
// будет всего несколько штук на весь лес.
class TreeType is
    field name
    field color
    field texture
...
// Фабрика легковесов решает когда создавать новый легковес, а когда можно
...
// Классы Tree и Forest являются клиентами легковеса. При желании, их
// можно слить в один класс, если класс Tree нет нужды расширять далее.
class Forest is
