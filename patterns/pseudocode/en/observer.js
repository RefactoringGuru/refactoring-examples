...
// реальной жизни это не всегда возможно (например, если вам нужно
// «слушать» подкласс). Поэтому здесь мы подключаем механизм подписки при
// помощи композиции.
class Editor is
...
// Набор конкретных слушателей. Они реализуют добавочный функционал, реагируя
// на извещения от издателя.
