...
namespace RefactoringGuru.Builder.Example.Builders
{
     ...
     * 
     * В данном случае мы производим руководство пользователя автомобиля с
     * помощью тех же шагов, что и сами автомобили. Это устройство позволит
     * создавать руководства под конкретные модели автомобилей, содержащие те
     * или иные фичи.
     */
