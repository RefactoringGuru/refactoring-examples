...
namespace RefactoringGuru.Builder.Example.Director
{
     ...
     * 
     * RU: Директор знает в какой последовательности заставлять работать
     * строителя. Он работает с ним через общий интерфейс Строителя. Из-за
     * этого, он может не знать какой конкретно продукт сейчас строится.
     */
