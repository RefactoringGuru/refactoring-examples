...
1. Весь код должен соответствовать стандарту стилей [PSR-2](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-2-coding-style-guide.md)

    Старайтесь соблюдать hard wrap на 80 символов, чтобы потом код можно было смотреть на сайте без горизонтальной прокрутки. 

2. Каждый пример должен находиться внутри неймспейса, RefactoringGuru/Patterns/{название паттерна}/{название примера}, например:
