...
/**
 * EN: Base factory class. Note that "factory" is merely a role for the class. It
...
public abstract class Dialog {
     ...
     * button objects.
     *
     * RU: Подклассы будут переопределять этот метод, чтобы создавать конкретные объекты продуктов, разные для каждой фабрики.
     */
